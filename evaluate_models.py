...
def plot_results(results_dict):
    ...
    all_precisions = [res[2] for res in results_dict.values()] 
    all_recalls = [res[3] for res in results_dict.values()] 
    ...
    best_conf_matrix = results_dict[best_run_id][4]  
